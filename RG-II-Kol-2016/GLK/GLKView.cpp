...
{
	if (nChar == VK_RIGHT) m_glRenderer.ugaoLevo-= 10.0;
	if (nChar == VK_LEFT) m_glRenderer.ugaoLevo += 10.0;
	if (nChar == VK_UP) m_glRenderer.ugaoGore += 10.0;
	if (nChar == VK_DOWN) m_glRenderer.ugaoGore -= 10.0;

	if (nChar == 'Q') m_glRenderer.ugaoVetrenjace += 10.0;
